...
import type { Listing, Category, RawListing } from '~/models';
...
describe('listingStore (Zustand)', () => {
  ...
  describe('updateListing', () => {
    it('should format and send update data correctly', async () => {
      ...
      expect(api.updateListing).toHaveBeenCalledWith("1", expect.objectContaining({
        title: "Updated Listing",
        description: "New description",
        endDate: "2024-12-31",
        listingPrice: "199.99",
  ...
  describe('addListing', () => {
    it('should format and send new listing data correctly', async () => {
      ...
      // Check if api was called with correctly formatted data
      expect(api.addListing).toHaveBeenCalledWith(expect.objectContaining({
        title: "New Listing",
        description: "Brand new item",
        endDate: "2023-11-30",
        listingPrice: "50",
