...
describe('ListingForm validation', () => {
  ...
  describe('Title validation', () => {
    it('shows error for titles less than 3 characters', async () => {
      ...
      const error = screen.getByText('Please enter a listing title of 3-80 characters');
    ...
    it('accepts valid titles', async () => {
      ...
      const error = screen.queryByText('Please enter a listing title of 3-80 characters');
  ...
  describe('Description validation', () => {
    it('shows error for descriptions less than 10 characters', async () => {
      ...
      const error = screen.getByText('Please enter a description of 10-500 characters');
      expect(error).toBeInTheDocument();
    });
    
    it('accepts valid descriptions', async () => {
      const { user } = renderForm();
      ...
      const error = screen.queryByText('Please enter a description of 10-500 characters');
      expect(error).not.toBeVisible();
    });
  });
  ...
  describe('Conditional rendering', () => {
    ...
    it('renders loading indicator when categories are loading', () => {
      ...
      expect(screen.getByRole('img', { name: /loading animation/i })).toBeInTheDocument();
    });
  });
});