...
describe('DateInput', () => {
  ...
  it('applies custom classes', () => {
    const defaultClass = "block w-full px-3 py-2 mt-1 border rounded-md text-black focus:ring-primary focus:border-primary focus:bg-transparent placeholder:italic peer";
