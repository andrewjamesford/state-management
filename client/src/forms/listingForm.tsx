...
const handleTextChange =
  (field: keyof ListingSchema, setFormState: React.Dispatch<React.SetStateAction<ListingSchema>>) =>
          ...
          subCategoryData && (
            <Select
              ...
              options={[
                {
                  value: 0,
                  label: formState.categoryId === 0 ? "Select a category first" : "Select a sub category...",
                  className: "text-muted-foreground italic",
...
const ItemDetailsSection = ({ formState, setFormState }: SectionProps) => (
  <>
    ...
    <fieldset>
      ...
      <div className="mt-6">
        <legend className="block text-sm font-medium text-gray-700">Condition</legend>
        <RadioButton
          id="used"
          name="condition"
          value="false"
...
const PriceAndPaymentSection = ({ formState, setFormState }: SectionProps) => (
  <>
    ...
    <fieldset>
      ...
      <div className="mt-6">
        <legend className="block text-sm font-medium text-gray-700">Payment options</legend>
...
const ShippingSection = ({ formState, setFormState }: SectionProps) => (
  <>
    ...
    <fieldset>
      <legend className="block text-sm font-medium text-gray-700">Pick up?</legend>
      <div className="mt-6">
        <RadioButton
          id="pick-up-true"
          name="pick-up"
    ...
    <fieldset>
      <legend className="block text-sm font-medium text-gray-700">Shipping options</legend>
      <div className="mt-6">
        <RadioButton
...
export default function ListingForm(listingFormProps: ListingFormProps) {
  ...
  return (
    <>
      ...
      <PriceAndPaymentSection formState={formState} setFormState={setFormState} />
